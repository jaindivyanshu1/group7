    ...
    <div>
        ...
        <div className="header">
            <div className="header_text">
                <h1>INTRODUCING: <span>CodeSphere</span></h1>
                <p>Revolutionize teamwork with CodeSphere, a real-time web based code editor like Google Docs for projects.
                ...
                <button onClick={() => navigate('/home')} className='btn trybtn'>Let's try CodeSphere</button>
            </div>
